...
base_item_model = api.model(
    "Item",
    {
        "order_id": fields.Integer(required=True, description="The id of order"),   
...
order_args.add_argument(
    "customer_name", type=str, location="args", required=False, help="List orders by customer name"
)
order_args.add_argument(
